<x-filament-panels::page>
    ...
    <div class="sticky right-0 justify-self-end py-5 rounded-full shadow-lg"
        ...
        <button class="relative" onclick="handleChatClick()">
            <!-- Icon: Chat -->
            <span>
                <span
                    class="absolute top-0 right-0 transform translate-x-1/2 -translate-y-1/2 text-white text-xs font-bold rounded-full px-2 py-0.5 shadow"
                    style="background-color: rgb(255, 40, 40);">
                    5
                </span>
            </span>
